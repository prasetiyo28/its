...
import 'package:its/jalurBill.dart';
import 'package:its/jalurPeb.dart';
import 'package:its/pelabuhanEksportir.dart';

class Maps4 extends StatelessWidget {
  final Datas datas;

  Maps4({Key key, this.datas}) : super(key: key);
  @override
  ...
  _navigateSimulasiMaps(BuildContext context) async {
    final result = await Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => PelabuhanEksportir(
                  datas: datas,
                )));
